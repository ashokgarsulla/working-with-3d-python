...
# Form implementation generated from reading ui file 'c:\Users\ashok\Downloads\Phantom Test Software\Screen\Base\Base.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox.setGeometry(QtCore.QRect(40, 10, 911, 80))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\ashok\\Downloads\\Phantom Test Software\\Screen\\Base\\../../../icons8-left-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon)
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_2.setGeometry(QtCore.QRect(800, 10, 93, 28))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\ashok\\Downloads\\Phantom Test Software\\Screen\\Base\\../../../icons8-right-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2.setIcon(icon1)
        self.pushButton_2.setCheckable(False)
        self.pushButton_2.setObjectName("pushButton_2")
        self.groupBox_2 = QtWidgets.QGroupBox(Form)
        self.groupBox_2.setGeometry(QtCore.QRect(40, 110, 911, 101))
        ...
        self.progressBar.setGeometry(QtCore.QRect(40, 830, 951, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setTextVisible(True)
        self.progressBar.setInvertedAppearance(False)
        self.progressBar.setObjectName("progressBar")
        self.frame = QtWidgets.QFrame(Form)
        self.frame.setGeometry(QtCore.QRect(40, 250, 911, 541))
